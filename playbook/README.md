...
vector
Запуск
Для запуска playbook нужно выполнить команду ansible-playbook -i inventory/prod.yml site.yml, где inventory/prod.yml - путь к Inventory файлу, site.yml - файл playbook.
